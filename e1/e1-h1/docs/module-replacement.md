...
neighbors supplied by the C++ DPI environment. This keeps the CPU, systolic
array, RGMII ingress, SRAMs, and latch buffer independently replaceable instead
of proving them only as one coupled integration test.
