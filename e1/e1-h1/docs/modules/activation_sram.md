# `e1_h1_config_sram` Activation Instance
...
IP manifest: `e1/e1-h1/ip/activation_sram.json`

C++ model: `e1/e1-h1/cmodels/activation_sram.json`

L1.5 hybrid run: `e1_h1_activation_sram_hybrid`
...
instance boundary for activation tiles while detailed request/response ports are
...
future SRAM request/response contract once that contract is documented.
...
The C++ chip model owns activation storage behavior until RTL ports are
introduced.
...
activation-memory cases and its flist is gathered.
